# Security audit — mesh-word-relay

Generated: **2026-08-22T13:14:31.267Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "2047c2efe52de8dd6b968fdc36df5d04a9e88472f9ed5ac5101409ca30c8049e",
  "pubkeyB": "2047c2efe52de8dd6b968fdc36df5d04a9e88472f9ed5ac5101409ca30c8049e"
}
```
...
```json
{
  "pubkeyA": "bc5959d79d16a4b5",
  "pubkeyB": "b8f4b4b0271a9cc4"
}
```
...
```json
{
  "plantedExpiresAt": 1787404411261,
  "now": 1787404471264
}
```
...
```json
{
  "realPubkey": "011df4eaf9f9a395",
  "forgerPubkey": "ae1e758f2c67aa7a"
}
```
...
```json
{
  "forgedPubkey": "aea9e1f9d0ebc40f",
  "realPubkey": "cd7a6d75f2102714"
}
```
